              ...
              <ul className="custom-list">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="https://www.linkedin.com/in/benjamin-bushman/" className="text-white" target="_blank">/in/benjamin-bushman</a></span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="https://github.com/benbushman98" className="text-white" target="_blank">benbushman98</a></span>
                  </h6>
                </li>
              </ul>
